-- SQL скрипт для наполнения хранилища из источников
...
-- запрос данных из источника Source1
SELECT  order_id,
		order_created_date,
...
union
-- запрос данных из источника Source2
SELECT  t2.order_id,
...
union
-- запрос данных из источника Source3
SELECT  t1.order_id,
...
--Запрос данных для нового источника из задания Проекта
UNION
SELECT  t1.order_id,
        t1.order_created_date,
        t1.order_completion_date,
